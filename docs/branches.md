...
- **SearchApi**: fase 4 incorporada (servicio de busqueda consultando Solr, caches combinadas CCache/Memcached, consumo de eventos RabbitMQ y endpoint de flush administrable).
- **Infra/Docker**: docker-compose orquestando microservicios + MySQL + MongoDB + Solr + Memcached + RabbitMQ, con core de Solr precreado.
